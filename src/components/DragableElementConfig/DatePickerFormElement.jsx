...
export const DatePickerFormElement = {
  ...
  formComponent: () => (
    <>
      <div>This is a date picker in the form</div>
    </>
  ),
  designerBtnElement: {
...
export const PropertiesComponent = ({ elementInstance }) => {
    ...
    const [initialMinDate] = useState(extraAttributes.minDate ? new Date(extraAttributes.minDate) : null);
    const [initialMaxDate] = useState(extraAttributes.maxDate ? new Date(extraAttributes.maxDate) : null);
